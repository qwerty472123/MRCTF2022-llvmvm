...
memory[0x1cb] = 4 * ((int)memory[0x1c3] + (int)0x1) + 64 * 0x0 + memory[0xb5];
...
memory[0x1cb] = 4 * ((int)memory[0x1c3] + (int)0x2) + 64 * 0x0 + memory[0xb5];
[unsigned int* memory[0x1cb]] = memory[0x1bf];
memory[0x1bf] = (int)[unsigned int* memory[0x55]] + (int)0x1abcdef1;
memory[0x1c3] = (int)0x4 * (int)[unsigned int* memory[0x109]];
memory[0x1c3] = ((int)memory[0x1c3] + (int)0x3);
memory[0x1cb] = 4 * ((int)memory[0x1c3] + (int)0x3) + 64 * 0x0 + memory[0xb5];
[unsigned int* memory[0x1cb]] = memory[0x1bf];
